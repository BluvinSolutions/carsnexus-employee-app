...
class CustomTheme {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      border: const OutlineInputBorder(borderSide: BorderSide(color: AppColors.stroke, width: 1), borderRadius: AppBorderRadius.k06),
      enabledBorder: const OutlineInputBorder(borderSide: BorderSide(color: AppColors.stroke, width: 1), borderRadius: AppBorderRadius.k06),
      focusedBorder: const OutlineInputBorder(
        borderSide: BorderSide(color: AppColors.primary, width: 2),
        borderRadius: AppBorderRadius.k06,
      ),
      errorBorder: const OutlineInputBorder(borderSide: BorderSide(color: AppColors.error, width: 1), borderRadius: AppBorderRadius.k06),
      focusedErrorBorder: const OutlineInputBorder(borderSide: BorderSide(color: AppColors.error, width: 2), borderRadius: AppBorderRadius.k06),
      labelStyle: Typographies.textTheme.bodyMedium!.copyWith(color: AppColors.subText),
      floatingLabelStyle: Typographies.textTheme.bodyMedium!.copyWith(color: AppColors.primary),
      hintStyle: Typographies.textTheme.bodySmall!.copyWith(color: AppColors.subText),
      errorStyle: Typographies.textTheme.bodySmall!.copyWith(color: AppColors.error),
      helperStyle: Typographies.textTheme.bodySmall!.copyWith(color: AppColors.subText),
    ...
    tabBarTheme: TabBarThemeData(
      ...
      unselectedLabelStyle: Typographies.textTheme.labelLarge!.copyWith(
          color: AppColors.subText
      ),
