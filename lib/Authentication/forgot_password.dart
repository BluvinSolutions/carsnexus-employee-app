      ...
      child: Scaffold(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  getTranslated(context, LangConst.enterYourRegisteredPhoneNumberWeWillSendAnOTP).toString(),
                  maxLines: 2,
                ...
                ElevatedButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      authProvider.callForgot(body, context);
                    }
                  },
        ...
        bottomNavigationBar: Column(mainAxisSize: MainAxisSize.min, children: [
          Align(
            ...
            child: RichText(
                text: TextSpan(text: getTranslated(context, LangConst.rememberYourPassword).toString(), style: Theme.of(context).textTheme.bodyMedium, children: [
              TextSpan(
                text: getTranslated(context, LangConst.loginButton).toString(),
