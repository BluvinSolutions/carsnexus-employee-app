...
class _OtpVerificationScreenState extends State<OtpVerificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ModalProgressHUD(
      inAsyncCall: authProvider.isOtpLoader,
      opacity: 0.5,
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    labelText: getTranslated(context, LangConst.verificationCode).toString(),
                    filled: true,
                    floatingLabelBehavior: FloatingLabelBehavior.auto,
                    fillColor: otpFocusNode.hasFocus ? AppColors.primary.withAlpha(40) : Colors.white,
                  ),
                ),
                const HeightBox(40),
                ElevatedButton(
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      authProvider.callForgotValid(body, context);
                    }
                  },
                ...
                Align(
                  ...
                  child: RichText(
                      text: TextSpan(text: getTranslated(context, LangConst.doNotGetOTP).toString(), style: Theme.of(context).textTheme.bodyMedium, children: [
                    TextSpan(
