                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: getTranslated(context, LangConst.userName).toString(),
                          filled: true,
                          floatingLabelBehavior: FloatingLabelBehavior.auto,
                          fillColor: userNameFocusNode.hasFocus ? AppColors.primary.withAlpha(40) : Colors.white,
                        ),
                      ),
                      const HeightBox(15),
                      TextFormField(
                        ...
                        inputFormatters: [
                          ...
                          FilteringTextInputFormatter.allow(RegExp(r"[a-zA-Z0-9@.]+")), // To allow only email valid characters
                        ],
                        decoration: InputDecoration(
                          labelText: getTranslated(context, LangConst.email).toString(),
                          filled: true,
                          floatingLabelBehavior: FloatingLabelBehavior.auto,
                          fillColor: emailFocusNode.hasFocus ? AppColors.primary.withAlpha(40) : Colors.white,
                        ),
                      ),
                      const HeightBox(15),
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: getTranslated(context, LangConst.labelPhoneNumber).toString(),
                          filled: true,
                          floatingLabelBehavior: FloatingLabelBehavior.auto,
                          fillColor: phoneNumberFocusNode.hasFocus ? AppColors.primary.withAlpha(40) : Colors.white,
                        ),
                      ),
                      const HeightBox(40),
                      ElevatedButton(
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            Map<String, dynamic> body = {"name": profileProvider.userNameController.text, "phone_no": profileProvider.phoneNumberController.text};
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          fillColor: currentPasswordFocusNode.hasFocus ? AppColors.primary.withAlpha(40) : Colors.white,
                          suffixIcon: InkWell(
                            onTap: () {
                              setState(() {
                                _isObscureTextCurrentPassword = !_isObscureTextCurrentPassword;
                              });
                            },
                            child: Icon(
                              _isObscureTextCurrentPassword ? Icons.visibility_off_outlined : Icons.visibility_outlined,
                            ),
                          ),
                        ),
                      ),
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          filled: true,
                          fillColor: newPasswordFocusNode.hasFocus ? AppColors.primary.withAlpha(40) : Colors.white,
                          suffixIcon: InkWell(
                            onTap: () {
                              setState(() {
                                _isObscureTextNewPassword = !_isObscureTextNewPassword;
                              });
                            },
                            child: Icon(
                              _isObscureTextNewPassword ? Icons.visibility_off_outlined : Icons.visibility_outlined,
                            ),
                          ),
                        ),
                      ),
                      ...
                      ElevatedButton(
                        onPressed: () {
                          if (_formKeyChangePassword.currentState!.validate()) {
                            Map<String, dynamic> body = {"old_password": profileProvider.currentPasswordController.text, "password": profileProvider.newPasswordController.text, "password_confirmation": profileProvider.confirmPasswordController.text};
