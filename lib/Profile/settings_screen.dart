...
import 'package:carsnexus_employee/Profile/edit_profile_screen.dart';
...
import 'package:carsnexus_employee/main.dart';
    ...
    return ModalProgressHUD(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(getTranslated(context, LangConst.settings).toString()),
        ),
        body: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              SwitchListTile(
                  shape: const RoundedRectangleBorder(borderRadius: AppBorderRadius.k08, side: BorderSide(color: AppColors.stroke)),
                  contentPadding: const EdgeInsets.only(left: Amount.screenMargin, top: 5, bottom: 5),
                  visualDensity: const VisualDensity(vertical: -4, horizontal: -4),
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      Map<String, dynamic> body = {"noti": profileProvider.isNotification == true ? 1 : 0};
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    decoration: const BoxDecoration(color: AppColors.white, borderRadius: BorderRadius.only(topRight: Radius.circular(28), topLeft: Radius.circular(28))),
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            getTranslated(context, LangConst.language).toString(),
                            style: Theme.of(context).textTheme.titleMedium!.copyWith(color: AppColors.bodyText, fontWeight: FontWeight.w600),
                          ),
                        ),
                        ListView.builder(
                            itemCount: Language.languageList().length,
                            shrinkWrap: true,
                            padding: const EdgeInsets.only(left: Amount.screenMargin, right: Amount.screenMargin),
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                title: Text(
                                  ...
                                  style: Theme.of(context).textTheme.labelLarge!.copyWith(color: AppColors.bodyText, fontWeight: FontWeight.w500),
                                ),
                                trailing: Icon(
                        ...
                        //   title: Text("English (US)",style: Theme.of(context).textTheme.labelLarge!.copyWith(
                        ...
                        //   contentPadding: EdgeInsets.zero,
                        //   visualDensity: VisualDensity(horizontal: -4, vertical: -4),
                        //   title: Text("Arabic",style: Theme.of(context).textTheme.labelLarge!.copyWith(
                        //       color: AppColors.bodyText,
                        //       fontWeight: FontWeight.w500
                        //   ),),
                        //   groupValue: _language,
